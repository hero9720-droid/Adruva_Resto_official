...
const migrations: { name: string; sql: string }[] = [
  ...
  // ── 28. Phase 50: Unified Intelligence Delta ───────────────────────────
  {
    name: '20260428_unified_delta',
    sql: `
      -- LOYALTY & RETENTION
      ...
      ALTER TABLE staff ADD COLUMN IF NOT EXISTS epi_score DECIMAL(5,2) DEFAULT 0;
