...
exports.getWastageRiskAlerts = getWastageRiskAlerts;
exports.generateWastageAnalytics = generateWastageAnalytics;
exports.runPredictiveEngine = runPredictiveEngine;
const db_1 = require("../../lib/db");
async function getWastageRiskAlerts(outlet_id) {
    // 1. Join current stock with predicted usage and shelf life
    const risks = await db_1.db.query(`
    SELECT 
      i.id, 
      i.name, 
      i.current_stock,
...
async function generateWastageAnalytics(outlet_id) {
    const wastage = await db_1.db.query(`
    SELECT 
      reason, 
...
async function runPredictiveEngine(outlet_id) {
    // Logic: 
