...
async function logStockMovement(data) {
...
async function getAuditTrail(ingredient_id, limit = 50) {
...
async function reconcileStock(outlet_id, staff_id, physicalCounts) {
