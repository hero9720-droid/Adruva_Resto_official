...
exports.updateDailyConsumption = updateDailyConsumption;
exports.runForecaster = runForecaster;
exports.getStockPredictions = getStockPredictions;
const db_1 = require("../../lib/db");
async function updateDailyConsumption(outlet_id, date) {
...
async function runForecaster(outlet_id) {
    const ingredients = await db_1.db.query('SELECT id, name FROM ingredients WHERE outlet_id = $1 AND is_active = true', [outlet_id]);
...
async function getStockPredictions(outlet_id) {
