...
exports.runMatrixAnalysis = runMatrixAnalysis;
exports.getMatrixData = getMatrixData;
const db_1 = require("../../lib/db");
async function runMatrixAnalysis(outlet_id, period) {
    ...
    `, [outlet_id, period]);
        ...
        for (const item of items) {
            ...
            if (isPopHigh && isProfHigh)
                classification = 'STAR';
            else if (isPopHigh && !isProfHigh)
...
async function getMatrixData(outlet_id, period) {
