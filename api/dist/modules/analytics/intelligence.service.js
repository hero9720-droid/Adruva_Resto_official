...
exports.getUnifiedIntelligence = getUnifiedIntelligence;
const db_1 = require("../../lib/db");
async function getUnifiedIntelligence(chain_id, outlet_id) {
    ...
    // 1. Sales & Performance
    const sales = await db_1.db.query(`
