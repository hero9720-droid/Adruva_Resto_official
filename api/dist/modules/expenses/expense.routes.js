...
router.use((0, rbac_1.requireRole)(['outlet_manager'])); // Expenses are for managers
router.get('/', ExpenseController.getExpenses);
router.post('/', (0, validate_1.validateBody)(expense_schema_1.expenseSchema), ExpenseController.createExpense);
