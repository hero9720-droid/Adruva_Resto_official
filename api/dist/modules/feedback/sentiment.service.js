...
exports.processExternalMention = processExternalMention;
exports.getReputationFeed = getReputationFeed;
exports.approveAndSendReply = approveAndSendReply;
const db_1 = require("../../lib/db");
async function processExternalMention(outlet_id, data) {
...
async function getReputationFeed(outlet_id) {
...
async function approveAndSendReply(id, final_reply) {
    // Update local DB
    const res = await db_1.db.query(`
