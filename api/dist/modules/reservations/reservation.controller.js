...
exports.getSmartAvailability = getSmartAvailability;
exports.createSmartBooking = createSmartBooking;
...
const ReservationAIService = __importStar(require("./reservation.ai.service"));
// --- SMART RESERVATIONS & TABLE TURNS ---
async function getSmartAvailability(req, res) {
    const result = await ReservationAIService.predictTableAvailability(req.user.outlet_id);
    res.json({ success: true, data: result });
}
async function createSmartBooking(req, res) {
