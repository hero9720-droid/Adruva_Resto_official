...
exports.getPriceRecommendations = getPriceRecommendations;
const db_1 = require("../../lib/db");
async function calculateDynamicPricing(outlet_id) {
...
async function getPriceRecommendations(outlet_id) {
