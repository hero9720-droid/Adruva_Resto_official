...
export async function calculateMonthlySettlement(outlet_id: string, period: string) {
...
export async function getChainSettlementSummary(chain_id: string, period: string) {
