...
export async function getTerritoryOverview(manager_id: string) {
  ...
  if (outlets.rowCount === 0) return { metrics: {}, outlets: [] };
...
export async function createFieldReport(manager_id: string, outlet_id: string, data: any) {
