...
import { ChainInventoryAnalytics } from './ChainInventoryAI';
...
export default function InventoryTransfersPage() {
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700">
      ...
      <Tabs defaultValue="transfers" className="space-y-10">
        <TabsList className="bg-secondary p-2 rounded-2xl self-start border border-border shadow-inner">
           <TabsTrigger value="transfers" className="rounded-xl px-10 h-12 font-black text-xs uppercase tracking-widest data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-lg text-slate-500 transition-all border-none">Active Transfers</TabsTrigger>
           <TabsTrigger value="global" className="rounded-xl px-10 h-12 font-black text-xs uppercase tracking-widest data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-lg text-slate-500 transition-all border-none">Global Insights</TabsTrigger>
        </TabsList>

        <TabsContent value="global" className="mt-0">
           <ChainInventoryAnalytics />
        </TabsContent>
