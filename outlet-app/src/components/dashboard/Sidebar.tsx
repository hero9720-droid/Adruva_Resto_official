...
const navGroups = [
  {
    ...
    items: [
      ...
      { name: 'Waitlist',     href: '/dashboard/waitlist',     icon: Clock,           roles: ['admin', 'manager', 'outlet_manager', 'captain'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Engineering',  href: '/dashboard/menu/engineering', icon: BarChart3,    roles: ['admin', 'manager', 'outlet_manager'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Sustainability', href: '/dashboard/sustainability', icon: Cloud,        roles: ['admin', 'manager', 'outlet_manager'] },
      { name: 'Equipment',    href: '/dashboard/settings/equipment', icon: ShieldAlert,  roles: ['admin', 'manager', 'outlet_manager'] },
