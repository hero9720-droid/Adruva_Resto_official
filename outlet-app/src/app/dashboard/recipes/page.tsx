  ...
  return (
    <div className="space-y-8 font-sans">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-4xl font-black tracking-tight text-slate-900">Recipe Management</h1>
          <p className="text-slate-500 text-sm mt-1 font-medium">Manage Bill of Materials (BOM) and food costing.</p>
        </div>
      ...
      <div className="py-24 text-center bg-white rounded-3xl shadow-soft border border-slate-100">
        ...
        <h3 className="text-2xl font-black text-slate-900 tracking-tight">No Recipes Found</h3>
